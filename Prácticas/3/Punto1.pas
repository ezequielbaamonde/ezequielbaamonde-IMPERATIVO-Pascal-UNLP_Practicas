...
procedure GenerarArbol (var a: arbol);
 var s: socio; {elemento}
 begin
	if (a = NIL) then begin
		procedure CargarSocio(var s)
		procedure InsertarElemento(var a, s);
	end 
 end;
...
Procedure CargarSocio (var s: socio);
 ...
 begin
    s.numero:= random (51) * 100; {50 numeros aleatorios x 100}
    If (s.numero <> 0)
    then begin
           s.nombre:= vNombres[random(10)]; {RANDOM NAME}
           s.edad:= 12 + random (79); {Edad RANDOM entre 12 y 100}
         end;
 end;  
